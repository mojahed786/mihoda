...
function Experience() {
  const timeline = [
...

    {
      ...
      company: "",
      description:
        "Working as a Project Manager, responsible for planning, coordinating, and executing commercial and residential construction projects from initiation to successful completion. Managing project schedules, budgets, quality standards, resource allocation, contractor coordination, client communication, and site operations while ensuring timely delivery and compliance with safety regulations.Successfully managed projects for Birla Opus across the Bihar and Jharkhand region, along with commercial fit-out and construction projects including Papaya's Aroma (Chandigarh), Chroma, and Intune Store (Nagpur, Maharashtra). Experienced in overseeing residential buildings, commercial developments, and retail store projects by coordinating multidisciplinary teams, monitoring project progress, resolving on-site challenges, maintaining quality control, and ensuring projects are completed within the approved budget and timeline.",
    },
  ];
